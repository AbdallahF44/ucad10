                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true"
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid"
                                       placeholder="Your Article Title" wire:model="title"/>
                                <!--end::Input-->
                                @error('title')
                            ...
                            <div class="mb-5 fv-row">
                                <!--begin::Label-->
                                <label class="required fs-5 fw-bold mb-2">Article Content</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                    ...
                    <table class="table align-middle gs-0 gy-5">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div style="text-align: start"
                                     class="text-dark fw-bolder text-hover-primary mb-1 fs-6">
                                    {{$view_article_status==\App\Models\Article::STATUS_ACTIVE?'Active':'Inactive'}}
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true"
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" wire:model="title" class="form-control form-control-solid"
                                       placeholder="Your Article Title" name="title"/>
                                @error('title')
                                <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
                                @enderror
                                <!--end::Input-->
        ...
        <div wire:ignore.self class="modal fade" id="delete_article" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header" id="kt_modal_create_api_key_header">
                        <!--begin::Modal title-->
                        <h2>Are you sure you want delete <span style="color: {{$status==\App\Models\Article::STATUS_ACTIVE?'#00ff00':'#ff0000'}}">{{$title}}</span> article?</h2>
