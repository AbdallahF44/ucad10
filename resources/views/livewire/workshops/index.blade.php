        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle gs-0 gy-5">
                ...
                <tr>
                    ...
                    <th class="p-0 w-50px" style="border: none">Workshop Image</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div style="text-align: start"
                                ...
                                @if(isset($workshop->getMedia('workshops_images')[0]))
                                    <img style="border-radius: 50%" class="w-50px h-50px"
                                         src="{{$workshop->getMedia('workshops_images')[0]->getUrl()}}"/>
                                @else
                                    <img style="border-radius: 50%" class="w-50px h-50px"
                ...
                <form wire:submit.prevent="store" id="kt_modal_edit_card" class="form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true"
                            ...
                            <div class="mb-5 fv-row">
                                <!--begin::Label-->
                                <label class="fs-5 fw-bold mb-2">Workshop Image</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="file" wire:model="image" class="form-control form-control-solid"
                                       accept="image/*"
                                       placeholder="Your Workshop Images" name="image" value="{{old('image')}}"/>
                                <!--end::Input-->
                                @error('image')
