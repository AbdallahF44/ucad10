    ...
    <div class="container edublink-animated-shape">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="testimonial-slide">
                        <div class="content">
                            <div class="logo"><img src="{{asset('site/assets/images/testimonial/logo-01.png')}}" alt="Logo"></div>
                        ...
                        <div class="author-info">
                            <div class="thumb">
                                <img src="{{asset('site/assets/images/testimonial/testimonial-01.png')}}" alt="Testimonial">
                            </div>
                            <div class="info">
                ...
                <div class="swiper-slide">
                    <div class="testimonial-slide">
                        <div class="content">
                            <div class="logo"><img src="{{asset('site/assets/images/testimonial/logo-02.png')}}" alt="Logo"></div>
                            <p>Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor ux incididunt enim ad minim veniam quis nosrud citation laboris nisiste aliquip comodo perspiatix.</p>
                            <div class="rating-icon">
                                <i class="icon-23"></i>
                                <i class="icon-23"></i>
                        ...
                        <div class="author-info">
                            <div class="thumb">
                                <img src="{{asset('site/assets/images/testimonial/testimonial-02.png')}}" alt="Testimonial">
                            </div>
                            <div class="info">
                ...
                <div class="swiper-slide">
                    <div class="testimonial-slide">
                        <div class="content">
                            <div class="logo"><img src="{{asset('site/assets/images/testimonial/logo-03.png')}}" alt="Logo"></div>
                            <p>Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor ux incididunt enim ad minim veniam quis nosrud citation laboris nisiste aliquip comodo perspiatix.</p>
                            <div class="rating-icon">
                                <i class="icon-23"></i>
                                <i class="icon-23"></i>
                        ...
                        <div class="author-info">
                            <div class="thumb">
                                <img src="{{asset('site/assets/images/testimonial/testimonial-03.png')}}" alt="Testimonial">
                            </div>
                            <div class="info">
                ...
                <div class="swiper-slide">
                    <div class="testimonial-slide">
                        ...
                        <div class="author-info">
                            <div class="thumb">
                                <img src="{{asset('site/assets/images/testimonial/testimonial-04.png')}}" alt="Testimonial">
                            </div>
                            <div class="info">
        ...
        <ul class="shape-group">
            <li class="shape-1 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
                <img data-depth="1.4" src="{{asset('site/assets/images/about/shape-30.png')}}" alt="Shape">
            </li>
            <li class="shape-2 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
                <img data-depth="-1.4" src="{{asset('site/assets/images/about/shape-25.png')}}" alt="Shape">
            </li>
        </ul>
    </div>
    <ul class="shape-group">
        <li class="shape-3" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
            ...
            <img class="d-none-shape-dark" data-depth="2" src="{{asset('site/assets/images/others/dark-map-2-shape-3.png')}}" alt="Shape">
        </li>
    </ul>
</div>